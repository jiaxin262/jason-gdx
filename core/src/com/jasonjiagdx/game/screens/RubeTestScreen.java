...
public class RubeTestScreen implements Screen, InputProcessor {
    private static final String TAG = "RubeTestScreen";
    ...
    public RubeTestScreen(Game game) {
        this.mGame = game;
        ...
        mWord = jb2dJson.readFromFile(Gdx.files.internal("rube/jointTypes.json"), errMsg, null);
        mGround = jb2dJson.getBodyByName("ground");
//        mWord = new World(new Vector2(0, -10), true);
        mDebugRender = new Box2DDebugRenderer();

        mViewport = new ExtendViewport(13, 10);
